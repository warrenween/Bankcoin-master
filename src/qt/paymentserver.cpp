...
const QString BITCOIN_IPC_PREFIX("Bankcoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Bankcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Bankcoin: click-to-pay handler");
    else
...
{
    // clicking on Bankcoin: URLs creates FileOpen events on the Mac:
