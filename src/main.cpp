...
// Copyright (c) 2013 The Bankcoin developers
...
uint256 hashGenesisBlock("0x00000212879e4c9484173f1196fdbcc1eb26b08d9a68ede6d4949fdbc2144200");
static const unsigned int timeGenesisBlock = 1458126178;
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "already in already databases we Bankcoin from USA with reindexing.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x4d8862ccf49ea7bf17d7a777ea4a79476727136998f9985ef10e0941163b6672"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("BankcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BankcoinMiner : ProcessBlock, block not accepted");
    }
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running BankcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("BankcoinMiner terminated\n");
        throw;
    }
}
